...
const defaultIllustrations = {
  users: (
    <div className="relative">
      ...
      <div className="absolute -top-2 -right-2 w-8 h-8 bg-primary rounded-full flex items-center justify-center shadow-md border-2 border-background">
  ...
  offices: (
    <div className="relative">
      ...
      <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-primary rounded-full flex items-center justify-center shadow-md border-2 border-background">
  ...
  tasks: (
    <div className="relative">
      ...
      <div className="absolute -top-1 -left-1 w-6 h-6 bg-primary rounded-full flex items-center justify-center shadow-md animate-pulse border-2 border-background">
  ...
  notifications: (
    <div className="relative">
      ...
      <div className="absolute -top-1 -right-1 w-6 h-6 bg-primary rounded-full flex items-center justify-center shadow-md border-2 border-background">
  ...
  salary: (
    <div className="relative">
      ...
      <div className="absolute -top-1 -left-1 w-6 h-6 bg-primary rounded-full flex items-center justify-center shadow-md border-2 border-background">
        <span className="text-white font-bold text-xs">$</span>
      </div>
    </div>
  ),
...
export const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  return (
    ...
    <div className={`text-center ${sizeClasses[size]} ${className} max-w-2xl mx-auto`}>
      {/* Illustration */}
        ...
        {actions.length > 0 && (
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
            {actions.map((action, index) => (
              ...
              >
                {/* Icon wrapper - ensure it doesn't shift layout */}
...
export const EmptyOffices: React.FC<{ onAddOffice: () => void }> = ({ onAddOffice }) => {
  const t = useTranslations();
  return (
    <EmptyState
      illustration={defaultIllustrations.offices}
      type="offices"
      actions={[
        {
...
export const EmptyTasks: React.FC<{ isAdmin: boolean; onCreateTask?: () => void }> = ({ isAdmin, onCreateTask }) => {
  const t = useTranslations();
  return (
    <EmptyState
      illustration={defaultIllustrations.tasks}
...
export const EmptyAttendance: React.FC<{ onMarkAttendance?: () => void }> = ({ onMarkAttendance }) => {
  const t = useTranslations();
  return (
    <EmptyState
      illustration={defaultIllustrations.attendance}
      type="attendance"
      actions={
        onMarkAttendance
          ? [
...
export const EmptySalary: React.FC<{ onGenerateSalary?: () => void }> = ({ onGenerateSalary }) => {
  const t = useTranslations();
  return (
    <EmptyState
      illustration={defaultIllustrations.salary}
      type="salary"
      actions={
        onGenerateSalary
          ? [
...
export const EmptyReports: React.FC<{ onGenerateReport?: () => void }> = ({ onGenerateReport }) => {
  ...
  return (
    <EmptyState
      illustration={defaultIllustrations.reports}
      type="reports"
      actions={
        onGenerateReport
          ? [
...
export const EmptyAudit: React.FC<{ onViewLogs?: () => void }> = ({ onViewLogs }) => {
  const t = useTranslations();
  return (
    <EmptyState
      illustration={defaultIllustrations.audit}
      type="audit"
      actions={
        onViewLogs
          ? [
