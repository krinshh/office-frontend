...
export function VisualImpact() {
  return (
    <div className="flex w-full h-full bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex-col items-center justify-center p-8 relative overflow-hidden">
